...
K              = K_FL * (reef_area_USVI / reef_area_FL);
X0_raw = 5527.14; K_raw = 7639.84;
X0     = K * (X0_raw / K_raw);
...
p_fish        = 8;
discount_rate = 0.015;
scale_to_global = 284000 / reef_area_USVI;
Global_Pop      = 8e9;
...
ylabel('Biomass (kg)')
xlabel('Year')
title('Fish Biomass Projection — United States Virgin Islands  (n = 500)')
ylim([0 2500]); xlim([2022 2103])
legend('Location','northeast')
grid on

exportgraphics(gcf,'usvi_projection.png','Resolution',600)
